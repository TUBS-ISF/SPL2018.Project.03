...
public class HeaderBar extends HBox {
	...
	private void init() {
		...
		fromLangChooser.valueProperty().addListener(new ChangeListener<String>() {
			@Override
	...
	private void initProperties() {
		...
		fromLang.addListener(new ChangeListener<String>() {
			@Override
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
		...
		toLang.addListener(new ChangeListener<String>() {
			@Override
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				ActionEvent event = new ActionEvent(headerBar, headerBar);
				if (langChangedListener != null)
